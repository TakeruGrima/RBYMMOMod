...
--                 The sheet does not ride this -- `M.FIELDS` is scalars by
--                 design, and Wire says why (src/Wire.lua:1660-1672) -- it
--                 travels with the OUTCOME, in `catches`, which is where a
--                 grant already happened before any of this existed.  Same
--                 division of labour as `exp`: the event states the fact, the
